            ...
            <div class="container nav-container">
                ...
                <nav class="nav-menu premium-nav">
                    <ul class="nav-list">
                        ...
                        <li><a href="${SiteConfig.whatsapp}" class="btn-nav-cta" target="_blank">تواصل معنا</a></li>
                    </ul>
                </nav>
            </div>
        </header>
                ...
                <div class="footer-bottom">
                    ...
                    <p class="developer">
                        <a href="${SiteConfig.developer.instagram}" target="_blank" rel="noopener">
                            تصميم وتطوير: ${SiteConfig.developer.name}
                        </a>
                    </p>
                </div>
            </div>
...
class FloatingContact extends HTMLElement {
    connectedCallback() {
        ...
        <div class="floating-contact-lux">
            ...
            <button class="float-btn-lux back-top" aria-label="للأعلى" style="display: none;">
