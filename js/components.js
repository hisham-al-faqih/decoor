    ...
    this.innerHTML = `
        <header class="premium-header">
            <div class="nav-container">
                <a href="/" class="logo" aria-label="الرئيسية">
                    <img src="images/logo.webp" alt="${SiteConfig.name}">
                </a>
                <nav class="nav-menu">
                    <ul>
        ...
        <footer class="footer" id="contact">
            <div class="container">
                <div class="footer-content">
                    ...
                    <div class="footer-section">
                        ...
                        <ul style="list-style: none; padding: 0;">
                            <li><a href="/" style="text-decoration: none;">الرئيسية</a></li>
                            <li><a href="/#services" style="text-decoration: none;">خدماتنا</a></li>
                            <li><a href="/#projects" style="text-decoration: none;">أعمالنا</a></li>
                            <li><a href="${SiteConfig.whatsapp}" target="_blank" style="text-decoration: none;">تواصل معنا</a></li>
                        </ul>
                    </div>
                ...
                <div class="footer-bottom">
                    ...
                    <p class="developer">
                        <a href="${SiteConfig.developer.instagram}" target="_blank" rel="noopener" style="text-decoration: none; display: flex; align-items: center; gap: 8px;">
